...
<div className=" sm:hidden md:block lg:hidden xl:hidden 2xl:hidden w-[773px] min-h-screen text-[64px] font-bold mb-[370px] leading-[64px] max-sm:text-[36px] max-sm:left-[16px] max-sm:w-[315px] max-sm:h-[93px] max-sm:ml-4 max-sm:leading-8 ">
            FIND CLOTHES THAT MATCHES YOUR STYLE
             <h3 className="w-[545px] mt-[33px] font-normal leading-7 text-[20px] max-sm:w-[358px] max-sm:h-[50px] max-sm:text-[25px] lg:text-[30px] max-sm:mt-2 max-sm:mb-8  ">Browse through our diverse range of meticulously crafted garments, designed to bring out your individuality and cater to your sense of style.</h3>
